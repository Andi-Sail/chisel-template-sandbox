...
```sh
git clone git@github.com:Andi-Sail/chisel-template-sandbox.git
cd chisel-template-sandbox
```
...
#### Commit your changes
```sh
git commit -m 'Starting chisel-template-sandbox'
...
```sh
./mill chisel-template-sandbox.test
```
